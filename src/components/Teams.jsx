...
const Teams = () => {
  return (
    <motion.div
     ...
     xl:px-40 pt-30 text-gra-800 dark:text-white"
    >
      <Title
        title="Meet the team"
        desc="A pssionalte team of digital experts dedicated to your brands success."
      />
        ...
        {teamData.map((team, index) => (
          ...
          >
            ...
            <div className="flex-1">
              <h3 className="flex-bold text-sm">{team.name}</h3>
