...
const Footer = ({ theme, setTheme }) => {
  return (
    ...
    sm:pt-10 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24
     xl:px-40"
    >
      {/* Footer top */}
      <div className="flex justify-between lg:items-center max-lg:flex-col gap-10">
        ...
        >
          <h3 className="font-semibold">Subscripe to our newsletter</h3>
          ...
          <div className="flex gap-2 text-sm">
            ...
            />
            <button className="bg-primary text-white rounded px-6">Subscripe</button>
          </div>
        </motion.div>
      </div>
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="pb-6 text-sm text-gary-500 flex justify-center 
         sm:justify-between gap-4 flex-wrap"
      >
        <p className="text-gray-600 dark:text-gray-400">
          Copyright 2026 @ hishamRehab - All Rights Reserved.
        </p>
